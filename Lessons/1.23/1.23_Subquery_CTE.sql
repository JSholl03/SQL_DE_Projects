...
LIMIT 10;
-- CTE Example
-- Compare how much more 9or less) remote roles pay compared to onsite roles for each job title.
...
WHERE r.job_work_from_home = TRUE
    ...
    AND r.median_salary IS NOT NULL
